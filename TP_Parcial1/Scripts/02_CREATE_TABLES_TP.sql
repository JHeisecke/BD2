...
ADD CONSTRAINT E_F_CH CHECK (ESTADO = 'F' AND FECHA_FALLECIMIENTO IS NO NULL)
;
...
--nuevo
ALTER TABLE AHO_CUENTA_AHORRO
ADD CONSTRAINT F_C_CH CHECK (ESTADO = 'I' AND FECHA_FALLECIMIENTO IS NO NULL)
...
RENAME COLUMN TIPO_GATANTIA TO TIPO_GARANTIA
;
...
--nuevo
ALTER TABLE CRE_MODALIDAD_PRESTAMO
ADD CONSTRAINT T_G_CH CHECK (DESCRIPCION_MOD = 'AFD' AND TIPO_GARANTIA = 'CD')
...
ADD CONSTRAINT F_P_CH CHECK (FECHA_PRESENTACION = sysdate)

--nuevo
ALTER TABLE CRE_SOLICITUD_PRESTAMOS
ADD CONSTRAINT F_C_CH CHECK (SITUACION = 'A' AND MONTO_CONCEDIDO IS NOT NULL AND MONTO_CONCEDIDO <= MONTO_SOLICITADO)
